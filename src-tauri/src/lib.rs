...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Skill Studio
            commands::skill_studio::list_skill_files,
            commands::skill_studio::read_skill_file,
            commands::skill_studio::save_skill_file,
            commands::skill_studio::create_skill_file,
            commands::skill_studio::delete_skill_file,
            commands::skill_studio::create_custom_skill,
            commands::skill_studio::commit_skill_changes,
            commands::skill_studio::generate_ai_skill_content,
            // Sync
